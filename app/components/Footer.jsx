        ...
        <div className="flex items-center">
          <nav className="items-center">
            ...
            <div className="grid grid-flow-col gap-6 text-white">
              <a href="https://twitter.com/BeiEducacao" target="_blank" rel="noopener noreferrer">
                <svg
              ...
              <a href="https://www.youtube.com/channel/UCRk-HV6uJQoZ3RFY9rcyFXw" target="_blank" rel="noopener noreferrer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              <a href="https://www.facebook.com/beieducacao" target="_blank" rel="noopener noreferrer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
